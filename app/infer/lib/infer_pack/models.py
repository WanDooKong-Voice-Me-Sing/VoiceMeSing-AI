...
class SynthesizerTrnMs256NSFsid(nn.Module):
    ...
    def infer(
        ...
        print(f"Allocated memory: {torch.cuda.memory_allocated() / (1024 * 1024):.2f} MiB")
        print(f"Reserved memory: {torch.cuda.memory_reserved() / (1024 * 1024):.2f} MiB")
        print(f"Total memory (MiB): {torch.cuda.get_device_properties(0).total_memory / (1024 * 1024):.2f}")

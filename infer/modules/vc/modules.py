...
class VC:
    ...
    #         )            
            ################################################################
            output_dir = f"result/{user_id}"
            output_audio_path = os.path.join(output_dir, f"{model_id}_output_audio.wav")
            output_info_path = os.path.join(output_dir, f"{model_id}_output_info.txt")
